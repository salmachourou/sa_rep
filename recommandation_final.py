...
def remove_punctuation(text):
    ...
    return text
def item(numero):
    return dbase.loc[dbase['numero'] == numero]['nom_prenom'].tolist()[0].split(' - ')[0]
...
dbase.rename(columns=lambda x: x.replace('id', 'numero'), inplace=True)
...
recommend(item_id='c2d766ca982eca8304150849735ffef9', num=5)
